...
def main(args=None):
    ...
    parser.add_argument(
        "--root-dir", type=str, default=None, help="The root folder for the file browser."
    )
    parser.add_argument(
        "--allow-origin", type=str, default='', help="The Access-Control-Allow-Origin header, by default it's empty."
    )
    parser.add_argument(
        "--base-url", type=str, default=None, help="The base url for accessing the file browser"
    )
